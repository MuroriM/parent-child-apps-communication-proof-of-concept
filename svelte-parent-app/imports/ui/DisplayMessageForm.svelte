<script>
    ...
    if(iFrameLoaded){
        ...
        document.getElementById('iframe').contentWindow.postMessage({function: 'displayMessage', args: {messageText: outgoingMessageText}}, "http://localhost:3000/")
    }
    else{
...
<div>
    <form on:submit|preventDefault={handleSubmit}>
        <h3><label for="html">Send a message to display on the child app: </label></h3>
        <br />
